...
-   Cashback Claw Back Period: The minimum time period (e.g., 36 months) the loan must remain active. If the loan is fully repaid before this period expires, a full or pro-rata claw back of the cashback incentive is enforced.
...
-   Contract Anniversary Tracking: The model must track the age of each fixed-rate contract. All penalty-free allowances (lump sums and payment increases) accumulate strictly within an "anniversary year" and reset to zero exactly 12 months after the contract inception or its last restructure.
